...
SELECT addressaddress, address.phone
    FROM address
...
SELECT customer.customer_id, customer.first_name ||' '|| customer.last_name AS customer_name, film.title,
		 payment.amount, payment.payment_date, staff.first_name ||' '|| staff.last_name AS staff_nameFROM customer
